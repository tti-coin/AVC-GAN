...
if __name__ == "__main__":
    ...
    if args.is_gan_training:
        ...
        exp.train_gan(ae_setting, gan_setting) # TODO: hidden or decoded の分岐
        ...
        exp.generate_hiddens_real_reps(ae_setting, gan_setting) # TODO
        ...
        pdb.set_trace()
        exp.save_synth_data(ae_setting, gan_setting)
        exp.plot_dec_tsne(ae_setting, gan_setting)
