...
# --d_update 10 \
# --gan_iter 20000 \
# --wandb_notes "Experiments to generate 192 steps with non-conditional AutoEncoder"
...
# --d_update 10 \
# --gan_iter 20000 \
# --wandb_notes "Experiments to generate 288 steps with non-conditional AutoEncoder"
