...
if __name__ == "__main__":
    ...
    parser.add_argument("--accumulation_steps", type=int, default=1, help="accumulate steps")

    # synthtesizing
    parser.add_argument(
        "--load_iter", type=int, default=20000, help="which iteration of model to use"
    )
    parser.add_argument(
    ...
    ae_setting = (
            "{}_{}_{}_{}_ft{}_sl{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_lr{}".format(
                args.ae_model_id,
                args.ae_model,
                args.data,
                args.des,
